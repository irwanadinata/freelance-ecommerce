...
const ProductList = ({ products }) => {
  return (
    <div className="bg-[#FFFAF5] lg:py-4 mb-6">
      <p className="lg:w-10/12 mx-auto md:w-full font-semibold pb-2">Hanya Untukmu</p>
      ...
      <div className="border-b border-[#C4C4C4] border-solid h-1 lg:w-10/12 md:w-full mx-auto pt-6"></div>
    </div>
  );
};
